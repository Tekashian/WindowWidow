...
- ✅ 3 użytkowników testowych:
  - **admin@windowwidow.pl** / admin123 (Administrator - pełny dostęp)
  - **produkcja@windowwidow.pl** / prod123 (Pracownik produkcji)
  - **magazyn@windowwidow.pl** / mag123 (Magazynier)
- ✅ 3 profile okienne (Rehau, Veka, Aluplast)
- ✅ 3 typy szkła (dwuszybowe, trójszybowe, antywłamaniowe)
- ✅ 5 materiałów magazynowych (z jednym niskim stanem do testowania powiadomień)
- ✅ 3 produkty (okna różnych rozmiarów)

**⚠️ WAŻNE:** Polecenie `migrate:fresh` usuwa wszystkie dane! W produkcji użyj tylko `php artisan migrate`.
